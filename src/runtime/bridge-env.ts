import { LOGIN_APP_SECRET_ENV } from '../ui/console-auth';
 ...
 * these grant control over every bot (the console token) or let anyone sign
 * people into the console (the login app's secret).
 */
export const BRIDGE_ONLY_ENV: readonly string[] = [UI_TOKEN_ENV, LOGIN_APP_SECRET_ENV];
